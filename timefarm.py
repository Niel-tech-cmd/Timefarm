...
def main_timefarm(session ,amount, key):
...
if __name__ == "__main__":
    ...
    try :
        ...
        print(Fore.RED + Style.BRIGHT + data['error'])Session : ")
    balance_input = input("Enter Coin Amount : ")
    key = input("Enter Authorization Key  : ")
